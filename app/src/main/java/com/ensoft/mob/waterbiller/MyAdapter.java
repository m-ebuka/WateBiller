...
/**
 * Created by Ebuka on 25/07/2015.
 */
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ViewHolder(View itemView,int ViewType,Context c) {                 // Creating ViewHolder Constructor with View and viewType As a parameter
            ...
            if(ViewType == TYPE_ITEM) {
                ...
                Name = (TextView) itemView.findViewById(R.id.tv_meter_no);         // Creating Text View object from header.xml for name
        ...
        public void onClick(View v) {
            if(getPosition() == 0)
            {
                contxt.startActivity(new Intent(contxt, AboutActivity.class));
            }
            if(getPosition() == 1)
            {
                contxt.startActivity(new Intent(contxt, StreetListActivity.class));
            }
            if(getPosition() == 2)
            {
                contxt.startActivity(new Intent(contxt, StreetListActivity.class));
